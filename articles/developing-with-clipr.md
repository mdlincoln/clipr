...
to the clipboard, you may run
[`clipr_available()`](http://matthewlincoln.net/clipr/reference/clipr_available.md)
which will either return `TRUE` or `FALSE`. This will be particularly
useful for Linux-based systems, where clipr’s functionality depends on
the installation of additional software. If you wish to display system
...
1.  Examples that will try to use
